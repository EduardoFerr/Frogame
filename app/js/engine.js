...
     */
    var doc = global.document,
        ...
        audio = new Audio('audio/ImmigrantSongLedZeppelin.mp3'),
    ...
    audio.autoplay = true;
    audio.loop = true;
    audio.src = "audio/ImmigrantSongLedZeppelin.mp3";
    audio.preload = "auto";
    audio.play();
...
         */
    ...
    function render() {
         ...
         */
        var rowImages = [
            'recursos/water-block.png', // A linha superior é água
            'recursos/grass-block.png', // Linha 1 de 1 de grama
            'recursos/stone-block.png', // Linha 1 de 3 de pedra
            'recursos/stone-block.png', // Linha 2 de 3 de pedra
            'recursos/stone-block.png', // Linha 3 de 3 de pedra
            'recursos/grass-block.png', // Linha 1 de 1 de grama
     ...
     */
    Resources.load([
        'recursos/stone-block.png',
        'recursos/water-block.png',
        'recursos/grass-block.png',
        'recursos/enemy-bug.png',
        'recursos/char-boy.png',
        'recursos/pow.png'
    ]);
